...
public class bookcontrollorfac {
	...
	public void bookroom(){
		...
		faculty.bookRoomFaculty(s3,s2,s1,s4,s5,s6,"Admin");
	}
	...
	public void avail(){
		...
		String str=faculty.roomAvailability(day1.getText(), venue.getText(), start1.getText(), end1.getText());
	...
	public void cancel(){
		...
		String s3=start1.getText();
		String s4=day1.getText();
		faculty.cancelRoomBookingFaculty(dat.getText(), da.getText(), ven.getText(), stime.getText(),etime.getText(),"Admin");
		//System.out.print(str);
