...
public class facultycontroller {
	...
	@FXML
	    ...
	    try {
			...
			Parent root = FXMLLoader.load(getClass().getResource("roomavail.fxml"));
			Stage s1=new Stage();
    ...
    try {
		...
		FXMLLoader floader=new FXMLLoader(Main.class.getResource("bookroomfac.fxml"));
		Parent root = FXMLLoader.load(getClass().getResource("bookroomfac.fxml"));
		Stage s1=new Stage();
